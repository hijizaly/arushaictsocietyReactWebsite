    ...
    <div className={layout.sectionInfo}>
      ...
      <div className="flex flex-row flex-wrap sm:mt-10 mt-6">
          ...
          <Stack direction="row" spacing={5}>
              <MuiButton color="warning" variant="outlined" btnText="Sign Up" size="large"></MuiButton>
              <MuiButton color="warning" variant="outlined" btnText="Log In" size="large"></MuiButton>
          </Stack>
